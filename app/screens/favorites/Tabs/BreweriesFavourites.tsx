...
const ITEM_WITH = 25
const BreweriesFavourites: React.FC<Props> = ({ navigation }) => {
  const { breweryStore } = useStores()
  const { breweriesFavouritesList } = breweryStore
...
export default BreweriesFavourites
