...
function ScreenWithoutScrolling(props: ScreenProps) {
  ...
  return (
    ...
    >
      {isAndroid ? (
        <StatusBar barStyle={props.statusBar || "light-content"} backgroundColor={color.primary} />
      ) : (
        <StatusBar
...
function ScreenWithScrolling(props: ScreenProps, ref) {
  const insets = useSafeAreaInsets()
...
const ScreenWithScrollingRef = React.forwardRef(ScreenWithScrolling)
...
function ScreenRef(props: ScreenProps, ref) {
  if (isNonScrolling(props.preset)) {
    return <ScreenWithoutScrolling {...props} />
  } else {
    return <ScreenWithScrollingRef {...props} ref={ref} />
  }
}

const Screen = React.forwardRef(ScreenRef)
